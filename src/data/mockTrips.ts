...
export interface Trip {
  ...
  booked: number;
  totalSeats: number;
  currentBatchBooked: number; // seats booked in the CURRENT upcoming batch only
  popular: boolean;
  isElite?: boolean;
  location: string;
  destination: string;
...
export const mockTrips: Trip[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1598091383021-15ddea10925d?ixlib=rb-4.1.0&q=85&fm=jpg&crop=entropy&cs=srgb&dl=praneet-kumar-H8dcf-v98mA-unsplash.jpg",
    videoUrl: "",
